      ...
      {open && (
        <nav id="mobile-nav-panel" aria-label="Mobile" className="border-t border-slate-200 bg-white px-4 py-3">
          <Link
            ...
            className="block rounded-sm py-2 text-base font-medium text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Browse resources
          </Link>
        </nav>
